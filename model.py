...
def create_few_shot_examples(image_dir=None):
    recipes = {
        "green swirl bake": {
            ...
            "instruction": "Preheat oven to 400 degree F and grease a 3-quart dish. Boil cavatappi with peas and asparagus for 9-11 minutes, reserving 2/3 cup pasta water. Season and saute chicken in oil until golden (5-7 min). In the Dutch oven, melt butter, whisk in flour, salt, pepper, then stir in milk, cream cheese, broth, and reserved pasta water until thick. Toss in pasta, chicken, spinach, tomatoes; transfer to dish, top with Parmesan and panko, and bake 15-20 min until bubbly and golden."
        },
        "creamy pink layer": {
